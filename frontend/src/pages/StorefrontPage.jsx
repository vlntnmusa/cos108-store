      ...
      >
        ...
        <div style={{ padding: '20px 24px 24px' }}>
          ...
          <div style={{ marginBottom: 20 }}>
            <h3 style={{ fontWeight: 700, fontSize: 18, letterSpacing: '-0.2px', marginBottom: 4 }}>
              {product.name}
            </h3>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              <button
                ...
                style={{
                  ...
                  border: 'none', background: qty === 1 ? '#E5E5EA' : '#1D1D1F',
                  color: qty === 1 ? '#AEAEB2' : '#fff',
                  fontSize: 18, fontWeight: 400, cursor: qty === 1 ? 'default' : 'pointer',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  transition: 'all .15s',
                }}
              >−</button>
          ...
          <div style={{
            ...
            <span style={{ fontWeight: 700, fontSize: 22, letterSpacing: '-0.3px' }}>
              ${total}
            </span>
          </div>
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            <button
              ...
              style={{
                ...
                color: '#1D1D1F', transition: 'background .15s',
              }}
            ...
            <button
              onClick={() => { onConfirm(product, qty); onClose() }}
              style={{
...
export default function StorefrontPage({ addToCart }) {
  ...
  const [addedId, setAddedId]     = useState(null)   // confirmation flash
